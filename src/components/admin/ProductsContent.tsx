...
const ProductsContent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://papeleria-back.vercel.app/v2/papeleria/newproductapi', {
        method: 'POST',
        headers: {
  ...
  const handleUpdateProduct = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://papeleria-back.vercel.app/v2/papeleria/updateproductapi', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await fetch('https://papeleria-back.vercel.app/v2/papeleria/deleteproductapi', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
