      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <Image
              ...
              style={styles.logo}
            />
            <Text style={styles.companyInfo}>RUT: 1108561900</Text>
            <View style={styles.infoRow}>
              <View style={styles.iconContainer}>
                <PhoneIcon />
              </View>
              <Text style={styles.infoText}>+57 317 7828994</Text>
            </View>
            <View style={styles.infoRow}>
              <View style={styles.iconContainer}>
                <LocationIcon />
              </View>
              <Text style={styles.infoText}>Cra 10 Manzana c Casa 14 Jamundi</Text>
            </View>
        ...
        <View style={styles.footer}>
          ...
          <View style={[styles.infoRow, { justifyContent: 'center', marginTop: 8 }]}>
            ...
            <Text>Para cualquier consulta, contáctenos al (+57) 317 7828994, Tambien al correo Jamundopapeleria@gmail.com o visítenos en Cra 10 Manzana c Casa 14 Jamundi</Text>
          </View>
        </View>
      </Page>
    </Document>
