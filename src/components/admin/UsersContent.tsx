...
const UsersContent: React.FC = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch('https://papeleria-back.vercel.app/v2/papeleria/getUsersapi', {
        headers: {
  ...
  const confirmDelete = async () => {
    ...
    setError(null);
    try {
      const response = await fetch(`https://papeleria-back.vercel.app/v2/papeleria/deleteUserapi/${userToDelete.id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json'
        }
    ...
    try {
      ...
      if (selectedUser) {
        ...
        response = await fetch(
          `https://papeleria-back.vercel.app/v2/papeleria/updateUserapi/${selectedUser.id}`,
          {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json'
        ...
        response = await fetch('https://papeleria-back.vercel.app/v2/papeleria/createUserapi', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
